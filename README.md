...
and a landmark model when a region is focused. Lazio, Piemonte, Toscana, Veneto, Campania, Sicilia, Lombardia and Emilia-Romagna are fully built out with four illustrated, narrated readings each in English and Norwegian; the other 12
...
| `content/<region>.js` | reading content per region (English): four lessons, photo captions, credits. Lazio, Piemonte, Toscana, Veneto, Campania, Sicilia, Lombardia and Emilia-Romagna so far. |
