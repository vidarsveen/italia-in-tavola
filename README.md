...
and a landmark model when a region is focused. Lazio, Piemonte, Toscana, Veneto, Campania, Sicilia, Lombardia, Emilia-Romagna, Puglia, Trentino-Alto Adige, Friuli-Venezia Giulia, Liguria, Umbria, Marche, Abruzzo and Sardegna are fully built out with four illustrated, narrated readings each in English and Norwegian; the other 4
...
| `content/<region>.js` | reading content per region (English): four lessons, photo captions, credits. Lazio, Piemonte, Toscana, Veneto, Campania, Sicilia, Lombardia, Emilia-Romagna, Puglia, Trentino-Alto Adige, Friuli-Venezia Giulia, Liguria, Umbria, Marche, Abruzzo and Sardegna so far. |
