...

{
  ...
  headnote:{
    ...
    no:'<p>To ingredienser og ikke noe fett å gjemme seg bak, og derfor har cacio e pepe et rykte den fortjener. Det som binder den, er verken smør eller fløte, men stivelse: pastavann inneholder nok oppløst stivelse til å holde revet ost i en jevn emulsjon, og jo mindre vann du koker pastaen i, jo mer av den får du. Romerske kokker bruker en kjele som ser altfor liten ut.</p>'
