...
<tr><th>Smak</th><td>Høy syre, faste tanniner, middels fylde, salt avslutning</td></tr>
...
<tr><th>Smak</th><td>Middels fylde, frisk syre, faste, men polerte tanniner, salt lengde</td></tr>
<tr><th>Alkohol</th><td>13,5–14,5 %</td></tr>
<tr><th>Serveres</th><td>17 °C; drikkes ved 4–12 år</td></tr>
...
<tr><th>Serveres</th><td>18 °C, dekantert i to timer; ved ti år eller eldre</td></tr>
...
<div class="recap"><h4>Før du går videre</h4><ul>
<li>Brunello: 100 % Sangiovese fra Montalcino, fem år før slipp, Italias første DOCG. Rosso di Montalcino er utgaven som drikkes ung.</li>
<li>Vino Nobile: Sangiovese fra Montepulciano, mildere og bedre kjøp; ikke i slekt med Montepulciano d'Abruzzo.</li>
<li>Supertoskanerne begynte som regelbrytende bordviner i Bolgheri og hos Antinori; de endte med egne betegnelser og reformerte Chianti.</li>
  ...
  },
  {
    ...
    minutes: 8,
    hero: "bistecca",
    heroCaption: "Bistecca alla fiorentina: en tykk T-beinbiff av Chianina-okse, grillet rå over glør, saltet etterpå og aldri med sitron.",
    summary: "Toskansk matlaging er kunsten å få fattigdom til å smake rikt: usaltet brød, bønner, olivenolje, ville urter og én enorm biff, spist i skyggen av Brunelleschis kuppel.",
    html: `
<p class="lead">Toskanerne kaller sin egen matlaging <em>cucina povera</em>, fattigmannskost, og sier det med stolthet. Det er et kjøkken av brød, bønner, olivenolje, grønt og innmat, med kjøtt på festdager, og det kom på moten over hele verden nettopp fordi ingenting går til spille. De to ytterpunktene er en bolle ribollita, som nesten ikke koster noe, og bistecca alla fiorentina, som er det dyreste på menyen, og begge smaker av det samme prinsippet: få ingredienser, alle utmerkede.</p>
...
<li>Cannellini- og zolfinibønner er regionens protein; toskanerne har tilnavnet <em>mangiafagioli</em>, bønnespisere.</li>
...
<h2>Biffen</h2>
<p><strong>Bistecca alla fiorentina</strong> har regler. Den skal være en T-bein- eller porterhousebiff av Chianina-okse, minst fire fingre tykk, over en kilo og modnet. Den grilles over glør av eik eller oliventre, noen minutter på hver side og deretter stående på beinet, slik at utsiden svis og innsiden holder seg rød: <em>al sangue</em>, og en florentinsk kelner ser trist på deg om du ber om den gjennomstekt. Salt og pepper kommer på etter stekingen, med en tråd olje; sitron aldri. Den serveres til to eller flere, skåret fra beinet ved bordet, med cannellinibønner og ingenting annet. Vinen er Chianti Classico, med en syre som er laget for nettopp dette fettet.</p>

<h2>Lampredotto og den femte fjerdedelen</h2>
...
<p>Firenzes gatemat er innmat. Fra vogner rundt markedene selger <em>trippai</em> <strong>lampredotto</strong>, løpen eller kuas fjerde mage, småkokt i timevis i kraft med tomat og selleri, hakket, stablet i et rundstykke som er dyppet i kraften, og toppet med grønn saus og chiliolje. Florentinere av alle klasser spiser det stående klokken elleve om formiddagen. <strong>Trippa alla fiorentina</strong>, innmat stuet i tomat med parmesan, er utgaven du sitter ned til. Dette er den samme logikken som Romas femte fjerdedel: byens fattige spiste det de rike ikke ville ha, og gjorde det til noe de rike nå står i kø for.</p>
...
<p>Alt dette spises i skyggen av bygningen som fra alle innfartsveier forteller at du nærmer deg Firenze: <strong>Brunelleschis kuppel</strong>, reist over katedralen mellom 1420 og 1436 uten stillas fra bakken, et dobbelt skall av fire millioner murstein lagt i fiskebeinsmønster som fortsatt gjør den til den største murkuppelen som noen gang er bygget. En time lenger vest har Pisas klokketårn hellet siden byggerne nådde tredje etasje i 1178 og oppdaget at grunnen ga etter; det ble stabilisert mellom 1990 og 2001 og heller nå trygge fire grader. De to bygningene rammer inn regionen slik ribollita og bistecca rammer inn maten: den ene er genialitet i stor skala, den andre en vakker feil som alle har lært å elske.</p>

<div class="recap"><h4>Før du går videre</h4><ul>
<li>Toskansk matlaging er cucina povera: usaltet brød, bønner, olivenolje og grønt, forvandlet til ribollita, pappa al pomodoro og panzanella.</li>
<li>Bistecca er Chianina-T-bein, tykk, rå, saltet etterpå, servert med bønner og Chianti Classico.</li>
<li>Lampredotto er Firenzes gatemat; cantucci og Vin Santo avslutter hvert måltid.</li>
</ul></div>`
  }
  ]
};
