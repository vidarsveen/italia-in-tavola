/* Italia in Tavola — lesetekster for Toscana (IT-52), norsk bokmål. Bilder og krediteringer deles med den engelske utgaven. */
window.READINGS_NO = window.READINGS_NO || {};
window.READINGS_NO['IT-52'] = {
  credits: window.READINGS['IT-52'].credits,
  lessons: [
  {
    title: "Sangiovese: én drue, mange ansikter",
...
<tr><th>Duft</th><td>Surkirsebær, tørkede urter, fiol, lær, tomatblad</td></tr>
<tr><th>Smak</th><td>Høy syre, faste tanniner, middels fylde, smaksrik avslutning</td></tr>
...
<li>Den er en matvin: syre og tannin er laget for kjøtt, bønner og brød.</li>
  ...
  {
    title: "Chianti Classico og den svarte hanen",
...
<tr><th>Duft</th><td>Surkirsebær, tørkede urter, fiol, lær, et hint av eik</td></tr>
<tr><th>Smak</th><td>Middels fylde, frisk syre, faste, men polerte tanniner, lang og smaksrik avslutning</td></tr>
<tr><th>Alkohol</th><td>13,5–14,5 %</td></tr>
<tr><th>Serveres</th><td>17 °C; drikkes når den er 4–12 år gammel</td></tr>
<tr><th>Ved bordet</th><td>Bistecca alla fiorentina, pappardelle med villsvinragù, lagret pecorino</td></tr></table></aside>

<div class="recap"><h4>Før du går videre</h4><ul>
<li>Chianti Classico er den historiske åssonen mellom Firenze og Siena; vanlig Chianti er et mye større, enklere område.</li>
<li>Reglene gikk fra Ricasolis blanding med hvite druer til minst 80 % Sangiovese uten hvite druer; tre nivåer: Annata, Riserva, Gran Selezione.</li>
<li>Landsbynavn på etiketten (Radda, Gaiole, Panzano …) er den nye måten å lese stilen på.</li>
</ul></div>`
  },
  {
    title: "Brunello, Nobile og supertoskanerne",
    kicker: "Vin · Lesetekst 3 av 4",
    minutes: 7,
    hero: "bolgheri",
...
<tr><th>Duft</th><td>Tørket kirsebær, plomme, lær, tobakk, balsamiske urter, tørkede blomster</td></tr>
<tr><th>Smak</th><td>Fyldig, kraftige tanniner, høy syre, svært lang avslutning</td></tr>
<tr><th>Alkohol</th><td>14–15 %</td></tr>
<tr><th>Serveres</th><td>18 °C, dekantert i to timer; fra ti års alder</td></tr>
...
<li>Vino Nobile: Sangiovese fra Montepulciano, mildere og et bedre kjøp; ikke i slekt med Montepulciano d'Abruzzo.</li>
<li>Supertoskanerne begynte som regelbrytende bordviner i Bolgheri og hos Antinori; de endte med egne betegnelser og reformerte Chianti.</li>
</ul></div>`
  },
  {
    title: "Brød, bønner og den florentinske biffen",
    kicker: "Mat · Lesetekst 4 av 4",
    minutes: 8,
    hero: "bistecca",
    heroCaption: "Bistecca alla fiorentina: en tykk T-beinbiff av Chianina-okse, grillet lite stekt over glør, saltet etterpå og aldri med sitron.",
    summary: "Toscana gjør gammelt brød, bønner og kuas fjerde mage til mat folk står i kø for, og den ene overdådigheten, en biff på størrelse med en bok, følger den samme regelen.",
    html: `
<p class="lead">Klokken elleve om formiddagen står det kø ved en vogn like ved markedet i Firenze. Trippaioen bak den løfter et stykke lampredotto opp av en gryte der det har småkokt i timevis med tomat og selleri. Det er løpen, kuas fjerde mage. Han hakker den på en fjøl, dypper et rundstykke i kraften, legger på grønn saus og chiliolje og rekker det over i et stykke papir. En bygningsarbeider i støvete støvler spiser stående, og det gjør advokaten bak ham også. Den dyreste retten i denne byen er en biff på størrelse med en bok. De billigste er dette rundstykket og en skål med gårsdagens brød, og den samme regelen gjelder for alle tre: ingenting går til spille, og hver råvare må være god. Toskanerne kaller maten sin <em>cucina povera</em>, fattigmannskost, og de sier det med stolthet. Det er et kjøkken av brød, bønner, olje og grønt, med innmat på hverdager og kjøtt på festdager.</p>
<figure data-img="lampredotto"><figcaption>En lampredotto-bod i Firenze: kuas fjerde mage, småkokt og servert i et rundstykke med salsa verde.</figcaption></figure>
<p>Utgaven som serveres ved bordet, er <strong>trippa alla fiorentina</strong>, kumage stuet i tomat og toppet med parmesan. Roma har den samme vanen og kaller den den femte fjerdedelen. Byens fattige spiste det de rike ikke ville røre, og gjorde det til noe de rike nå står i kø for.</p>

<h2>Brød uten salt</h2>
<p>Biter du i et toskansk brød, mangler det noe. <strong>Pane toscano</strong> lages uten salt, og ingen har slått fast hvorfor. Én historie gir en middelaldersk saltskatt skylden. En annen sier at Pisa en gang blokkerte saltet til Firenze, og at byen lærte seg å klare seg uten. Den enkleste forklaringen er at alt som spises til brødet, er salt fra før: prosciutto, pecorino, fennikelsalamien finocchiona, ansjos. Florentinerne er fornøyde med å gi Pisa skylden. Uansett årsak blir usaltet brød fort tørt, ofte i løpet av en dag, så halve det toskanske kjøkkenet finnes for å bruke opp gårsdagens brød.</p>
<figure data-img="pane"><figcaption>Pane toscano, bakt uten salt. Det blir fort tørt.</figcaption></figure>
<p>Om vinteren betyr det <strong>ribollita</strong>, en suppe av cannellinibønner, svartkål, gulrot og løk som jevnes med tørt brød. Navnet betyr kokt på nytt: suppen kokes, settes bort til neste dag og kokes igjen til skjeen står i den. Når tomatene kommer, kokes brødet sammen med dem, hvitløk og basilikum til en grøt som heter <strong>pappa al pomodoro</strong>. Om sommeren bløtlegges det, klemmes og vendes med tomat, agurk og løk som <strong>panzanella</strong>. Og i november, når den nye oljen kommer grønn og uklar fra pressen, grilles en brødskive, gnis med hvitløk og druknes i olje; den skiven heter <strong>fettunta</strong>, den oljede skiven. Oljen presses av oliven som er høstet tidlig, og den er pepret nok til å få deg til å hoste. Toskanerne tar hosten som et kvalitetstegn.</p>
...
<h2>Bønnespisere</h2>
<p>Toskanerne har tilnavnet <em>mangiafagioli</em>, bønnespisere, og navnet er fortjent. Bønner var proteinet gjennom det meste av regionens historie, og det er de fortsatt: hvite cannellini og de mindre, gule zolfini, kokt møre og vendt med bare olje, salt og pepper. En skål med bønner følger mye annet, og den følger biffen.</p>

<h2>Biffen</h2>
<p>Biffen begynner med et dyr. <strong>Chianina</strong> er den svære hvite oksen fra Val di Chiana sør for Arezzo, og det er en av verdens eldste storferaser. Av den skjærer slakteren en T-beinbiff som er minst fire fingre tykk og veier over en kilo, og henger den til tørrmodning. Grillkokken legger den over glør av eik eller oliventre i noen minutter på hver side og reiser den så på beinet, slik at varmen når inn til midten. Utsiden svis, og innsiden holder seg rød, <em>al sangue</em>. Salt og pepper kommer på etterpå, med en tynn stråle olje, og sitron aldri. Den serveres til to eller flere og skjæres fra beinet ved bordet, med bønnene ved siden av og ingenting annet. Vinen er Chianti Classico, med en syre som er laget for nettopp dette fettet. Ber du om den gjennomstekt, ser en florentinsk kelner trist på deg.</p>
<p>I nesten fem år kunne byen ikke selge den. Italia fant sitt første tilfelle av kugalskap i januar 2001. Fra 1. april samme år forbød EU salg av storfekjøtt på bein fra dyr eldre enn tolv måneder, fordi risikoen satt i ryggraden. En bistecca er kjøtt på bein fra et dyr på rundt atten måneder. Firenze protesterte til Brussel, og forbudet sto til utgangen av 2005. Beinet kom tilbake i etapper, og fra 2008 var biffen det den alltid hadde vært.</p>
<aside class="facts"><h4>Nøkkelfakta</h4><ul>
<li>Olje: oliven høstet tidlig og presset grønn; pepperen som tar i halsen, er tegnet på at den er fersk.</li>
<li>Bønner: hvite cannellini og de mindre, gule zolfini; tilnavnet er <em>mangiafagioli</em>.</li>
<li>Bistecca: en T-bein- eller porterhousebiff av Chianina, en av verdens eldste storferaser, minst fire fingre tykk, over en kilo, tørrmodnet, fra et dyr på rundt atten måneder.</li>
<li>EU-forbudet mot storfekjøtt på bein fra dyr eldre enn tolv måneder varte fra 1. april 2001 til utgangen av 2005; bistecca kom fullt tilbake i 2008.</li>
<li>Ost: Pecorino Toscano DOP er mildere enn den romerske; utgaven fra Pienza er den mest verdsatte.</li>
<li>Brunelleschis kuppel, 1420–1436, fire millioner murstein, fortsatt den største murkuppelen som noen gang er bygget. Tårnet i Pisa har hellet siden 1178, ble stabilisert mellom 1990 og 2001 og heller rundt fire grader.</li>
</ul></aside>
...
<figure data-img="duomo"><figcaption>Brunelleschis kuppel over domkirken i Firenze, fire millioner murstein reist uten stillas mellom 1420 og 1436.</figcaption></figure>
<p>Fra alle veier inn til Firenze er kuppelen det første du ser. Filippo Brunelleschi reiste kuppelen over domkirken mellom 1420 og 1436 uten stillas fra bakken. Han bygde to skall, det ene inni det andre, og la fire millioner murstein i fiskebeinsmønster, slik at hver ring bar seg selv mens den vokste. Det er fortsatt den største murkuppelen som noen gang er bygget. En time lenger vest har klokketårnet i Pisa hellet siden 1178, da byggerne nådde tredje etasje og kjente grunnen gi etter. Ingeniører stabiliserte det mellom 1990 og 2001, og nå står det trygt med fire graders helling. Det ene er genialitet i stor skala, og det andre er en vakker feil som alle har lært å elske. Byen som reiste det ene, og aldri har gått lei av det andres uhell, setter seg hver dag til en biff på størrelse med en bok eller en skål med gårsdagens brød.</p>

<div class="recap"><h4>Før du går videre</h4><ul>
<li>Toskansk brød har ikke salt, så det blir tørt på en dag, og ribollita, pappa al pomodoro og panzanella finnes for å bruke det opp.</li>
<li>Bistecca er T-bein av Chianina, tykk, lite stekt, saltet etterpå, med bønner og Chianti Classico; fra 2001 til 2005 kunne den ikke selges lovlig.</li>
<li>Lampredotto er byens gatemat, og kuppelen og det skjeve tårnet er regionens to ytterpunkter.</li>
</ul></div>`
  }
  ]
};
